...
def inserts(data, prev_mails, prev_numbers, old_reservations):
    ...
    create_guest_table(prev_numbers, prev_mails, data['guest'], 15000, len(data['guest']))
    create_worker_table(prev_numbers, prev_mails, data['worker'], 5000, len(data['worker']))
